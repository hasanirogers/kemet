...
function CreateNextComponent ({ element, children, ...props }: CreateNextComponentProps) {
  ...
  const elementLoaders = {
    'accordion': () => import('../elements/accordion.js'),
    'accordion-panel': () => import('../elements/accordion-panel.js'),
    'alert': () => import('../elements/alert.js'),
    'avatar': () => import('../elements/avatar.js'),
    'badge': () => import('../elements/badge.js'),
    'button': () => import('../elements/button.js'),
    'card': () => import('../elements/card.js'),
    'carousel': () => import('../elements/carousel.js'),
    'carousel-current': () => import('../elements/carousel-current.js'),
    'carousel-first': () => import('../elements/carousel-first.js'),
    'carousel-last': () => import('../elements/carousel-last.js'),
    'carousel-next': () => import('../elements/carousel-next.js'),
    'carousel-prev': () => import('../elements/carousel-prev.js'),
    'carousel-slide': () => import('../elements/carousel-slide.js'),
    'carousel-total': () => import('../elements/carousel-total.js'),
    'checkbox': () => import('../elements/checkbox.js'),
    'combo': () => import('../elements/combo.js'),
    'count': () => import('../elements/count.js'),
    'drawer': () => import('../elements/drawer.js'),
    'draggable': () => import('../elements/draggable.js'),
    'fab': () => import('../elements/fab.js'),
    'field': () => import('../elements/field.js'),
    'flipcard': () => import('../elements/flipcard.js'),
    'flipcard-trigger': () => import('../elements/flipcard-trigger.js'),
    'icon-bootstrap': () => import('../elements/icon-bootstrap.js'),
    'icon-lucide': () => import('../elements/icon-lucide.js'),
    'input': () => import('../elements/input.js'),
    'modal': () => import('../elements/modal.js'),
    'modal-close': () => import('../elements/modal-close.js'),
    'multi-input': () => import('../elements/multi-input.js'),
    'option': () => import('../elements/option.js'),
    'password': () => import('../elements/password.js'),
    'popper': () => import('../elements/popper.js'),
    'popper-close': () => import('../elements/popper-close.js'),
    'radio': () => import('../elements/radio.js'),
    'radios': () => import('../elements/radios.js'),
    'scroll-nav': () => import('../elements/scroll-nav.js'),
    'scroll-snap': () => import('../elements/scroll-snap.js'),
    'scroll-snap-paginator': () => import('../elements/scroll-snap-paginator.js'),
    'scroll-snap-slide': () => import('../elements/scroll-snap-slide.js'),
    'select': () => import('../elements/select.js'),
    'sortable': () => import('../elements/sortable.js'),
    'sortable-item': () => import('../elements/sortable-item.js'),
    'svg': () => import('../elements/svg.js'),
    'svgs': () => import('../elements/svgs.js'),
    'tabs': () => import('../elements/tabs.js'),
    'tab-panel': () => import('../elements/tab-panel.js'),
    'tab': () => import('../elements/tab.js'),
    'textarea' : () => import('../elements/textarea.js'),
    'timer': () => import('../elements/timer.js'),
    'timer-display': () => import('../elements/timer-display.js'),
    'toggle': () => import('../elements/toggle.js'),
    'tooltip': () => import('../elements/tooltip.js'),
    'tracker': () => import('../elements/tracker.js'),
    'tracker-step': () => import('../elements/tracker-step.js'),
    'upload': () => import('../elements/upload.js'),
    'upload-file': () => import('../elements/upload-file.js')
  } as const;

  useEffect(() => {
    const load = elementLoaders[element as keyof typeof elementLoaders];
    if (!load) {
      console.error(`Unknown element "kemet-${element}"`);
      return;
    }
    load().then(() => setReady(true)).catch((event: unknown) => {
