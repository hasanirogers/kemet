...
<API element="timer" display="attributes" />
<br />

### Slots

<API element="timer" display="slots" />
<br />

### Events

<API element="timer" display="events" />
<br />

### Methods

<API element="timer" display="methods" />
<br />

### CSS Properties

<API element="timer" display="properties" />
<br />

### CSS Parts

<API element="timer" display="parts" />
<br />
