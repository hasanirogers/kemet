...
import * as stories from '../elements/upload.stories';
...
<kemet-tabs divider panel-effect="stacked">
  ...
  <kemet-tab-panel slot="panel">
    ...
    ### Import JavaScript
    ```javascript
    import 'kemet-ui/elements/upload';
    import 'kemet-ui/elements/upload-file';
    ```
  </kemet-tab-panel>
  <kemet-tab-panel slot="panel">
...
<docs-api tag="kemet-upload" />
<docs-api tag="kemet-upload-file" />
